...
services = {
  'monolithic' => {
    'start' => ['abiquo-tomcat', 'apache2', 'haproxy'],
  ...
  'v2v' => {
    'start' => ['abiquo-tomcat'],
    'not_start' => ['abiquo-aim', 'abiquo-delorean', 'abiquo-emmett', 'websockify'],
    'runs_liquibase' => false,
    'runs_wt_liquibase' => false },
  'remoteservices' => {
    'start' => ['abiquo-tomcat', 'websockify'],
    'not_start' => ['abiquo-aim', 'abiquo-delorean', 'abiquo-emmett'],
    'runs_liquibase' => false,
    'runs_wt_liquibase' => false },
  'kvm' => {
    'start' => ['abiquo-aim'],
    'not_start' => ['abiquo-tomcat', 'websockify', 'abiquo-delorean', 'abiquo-emmett'],
    'runs_liquibase' => false,
    'runs_wt_liquibase' => false },
  'monitoring' => {
    'start' => ['abiquo-delorean', 'abiquo-emmett'],
    'not_start' => ['abiquo-tomcat', 'websockify', 'abiquo-aim'],
    'runs_liquibase' => false,
    'runs_wt_liquibase' => true },
  'frontend' => {
    'start' => %w(apache2 haproxy),
    'not_start' => ['abiquo-tomcat', 'abiquo-aim', 'websockify', 'abiquo-delorean', 'abiquo-emmett'],
    'runs_liquibase' => false,
    'runs_wt_liquibase' => false },
  'websockify' => {
    'start' => ['websockify'],
    'not_start' => ['abiquo-tomcat', 'abiquo-aim', 'abiquo-delorean', 'abiquo-emmett', 'apache2', 'haproxy'],
    'runs_liquibase' => false,
    'runs_wt_liquibase' => false },
}
