...
default['abiquo']['yum']['base-repo'] = 'http://mirror.abiquo.com/el$releasever/4.6/os/x86_64'
default['abiquo']['yum']['updates-repo'] = 'http://mirror.abiquo.com/el$releasever/4.6/updates/x86_64'
